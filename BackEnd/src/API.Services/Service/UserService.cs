...
namespace API.Services.Service
{
    public class UserService : IUserService
    {
        ...
        public UserService(IConfiguration configuration, SignInManager<User> signInManager, UserManager<User> userManager, IUserRepository userRepository)
        {
        ...
        public async Task<IEnumerable<Request>> UserRequestsAsync(string userEmail)
        {
            var userRequests = await this.userRepository.GetUserRequestAsync(userEmail);
            return userRequests;
        }
