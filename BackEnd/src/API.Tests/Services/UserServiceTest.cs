...
namespace API.Tests.Services
{
    ...
    public class UserServiceTest
    {
        ...
        public void SetUp()
        {
            ...
            userService = new UserService(configuration, signInManager, userManager,userRepository);
        }
        ...
        {
            A.CallTo(() => userManager.FindByEmailAsync(A<string>.Ignored)).Returns(new User());
        ...
        [Test]
        public async Task When_UserRequestsAsync_Expect_RequestCollection()
        {
            var result = await userService.UserRequestsAsync("");
